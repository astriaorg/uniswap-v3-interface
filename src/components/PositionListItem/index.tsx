...
import { USDC_FLAME_DEVNET, USDC_FLAME_TESTNET, USDC_MAINNET, WRAPPED_NATIVE_CURRENCY } from '../../constants/tokens'
...
export function getPriceOrderingFromPositionForUI(position?: Position): {
  ...
  const stables = [USDC_MAINNET, USDC_FLAME_DEVNET, USDC_FLAME_TESTNET]
