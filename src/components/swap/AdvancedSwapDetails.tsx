    ...
    <StyledCard>
      <AutoColumn gap="sm">
        <RowBetween>
          <RowFixed>
            <MouseoverTooltip
              text="The amount you expect to receive at the current market price. You may receive less or more if the market price changes while your transaction is pending."
          ...
          <RowFixed style={{ marginRight: '20px' }}>
            ...
            >
              <ThemedText.DeprecatedSubHeader color={theme.deprecated_text3}>
                {trade.tradeType === TradeType.EXACT_INPUT ? 'Minimum received' : 'Maximum sent'} after slippage (
