...
export const darkTheme = {
  ...
  backgroundBackdrop: colors.gray800,
  backgroundSurface: '#121619',
  ...
  accentWarning: '#f19727',
  accentFailure: colors.red300,
  accentCritical: colors.red300,

  accentActionSoft: opacify(24, '#f19727'),
  accentActiveSoft: opacify(24, '#f19727'),
  accentSuccessSoft: opacify(24, colors.green400),
  accentWarningSoft: opacify(24, '#f19727'),
