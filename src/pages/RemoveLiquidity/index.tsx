                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          ...
                          <StyledInternalLink
                            to={`/remove/v2/${currencyA && WRAPPED_NATIVE_CURRENCY[chainId]?.equals(currencyA) ? 'TIA' : currencyIdA
                              }/${currencyB && WRAPPED_NATIVE_CURRENCY[chainId]?.equals(currencyB) ? 'TIA' : currencyIdB
                              }`}
                          >
                            Receive ETH
                          </StyledInternalLink>
