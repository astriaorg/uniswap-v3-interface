        ...
        <Wrapper>
          {position ? (
            <AutoColumn gap="lg">
              ...
              <LightCard>
                <AutoColumn gap="md">
                  <ThemedText.DeprecatedMain fontWeight={400}>Amount</ThemedText.DeprecatedMain>
                  <RowBetween>
              ...
              {showCollectAsWeth && (
                <RowBetween>
                  <ThemedText.DeprecatedMain>Collect as {nativeWrappedSymbol}</ThemedText.DeprecatedMain>
                  <Toggle
                    id="receive-as-weth"
