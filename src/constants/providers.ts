...
export const RPC_PROVIDERS: { [key in SupportedChainId]: StaticJsonRpcProvider } = {
  ...
  [SupportedChainId.FLAME_DEVNET]: new AppJsonRpcProvider(SupportedChainId.FLAME_DEVNET),
  [SupportedChainId.FLAME_TESTNET]: new AppJsonRpcProvider(SupportedChainId.FLAME_TESTNET),
}
